"""classificador_variacoes_geneticas file for ensuring the package is executable
as `classificador-variacoes-geneticas` and `python -m classificador_variacoes_geneticas`
"""
import importlib
